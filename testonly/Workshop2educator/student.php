<?php 
  ...
  <?php
    ...
    $sql = "SELECT * FROM student INNER JOIN subject ON student.subjectcode = subject.subjectcode";  
  ...
  text-align: left;">
    <tr>
      ...
      <th style = "border: 1px solid #ddd;text-align: left; padding: 15px;">Subject Name</th>
		<th style = "border: 1px solid #ddd;text-align: left; padding: 15px;">Student Name</th>
    </tr>
